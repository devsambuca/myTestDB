...
INSERT INTO customers (cust_id, cust_name, cust_address) VALUES (1, 'Ilya Petrov', 'Moscow, Lomonosova 22-10');
INSERT INTO customers (cust_id, cust_name, cust_address) VALUES (2, 'Larisa Zvereva', 'Sankt-Peterburg, Lermontova 2-110');
INSERT INTO customers (cust_id, cust_name, cust_address) VALUES (3, 'Ekaterina Solovjeva', 'Samara, Ishpaya 52-5');
INSERT INTO customers (cust_id, cust_name, cust_address) VALUES (4, 'Galina Ganina', 'Yoshkar-Ola, Pushkina 16-3');
INSERT INTO customers (cust_id, cust_name, cust_address) VALUES (5, 'Aleksandr Korolen', 'Kazan, Dekabristov 1-89');
INSERT INTO customers (cust_id, cust_name, cust_address) VALUES (6, 'Maksim Petrov', 'Moscow, Zelenaya 24-11');

/*Добавление данных в таблицу клиенты компании и их проекты*/

INSERT INTO projects_customers (proj_cust_id, proj_id, cust_id) VALUES (1, 1, 1);
INSERT INTO projects_customers (proj_cust_id, proj_id, cust_id) VALUES (2, 1, 2);
INSERT INTO projects_customers (proj_cust_id, proj_id, cust_id) VALUES (3, 2, 3);
INSERT INTO projects_customers (proj_cust_id, proj_id, cust_id) VALUES (4, 2, 6);
INSERT INTO projects_customers (proj_cust_id, proj_id, cust_id) VALUES (5, 3, 5);
INSERT INTO projects_customers (proj_cust_id, proj_id, cust_id) VALUES (6, 3, 4);
INSERT INTO projects_customers (proj_cust_id, proj_id, cust_id) VALUES (7, 4, 2);
INSERT INTO projects_customers (proj_cust_id, proj_id, cust_id) VALUES (8, 4, 1);
INSERT INTO projects_customers (proj_cust_id, proj_id, cust_id) VALUES (9, 1, 6);
